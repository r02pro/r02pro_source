...
Values <- c("$x$", "$y$", "$\\sqrt{x^2 + y^2}$",
            "$arccos(\\frac{x}{\\sqrt{x^2 + y^2}})$ if $y \\ge 0$; $-arccos(\\frac{x}{\\sqrt{x^2 + y^2}})$ if $y < 0$", "$x - i y$")
...
For example, the character `I` corresponds to raw value 49, and number 73, the space corresponds to raw value 20, and number 32, and the `!` corresponds to raw value 21, and number 33.
