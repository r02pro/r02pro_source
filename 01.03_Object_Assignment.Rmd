...
knitr::kable(matrix(c("TRUE", "FALSE", "NA", "Inf",
 "NaN", "NULL", "function", "if", "else", "for", "while",
  "break", "next", "repeat"), 7, 2))
```
...
Section <- c("\\@ref(basic-vectors)","\\@ref(matrix)","\\@ref(array)","\\@ref(dataframe)","\\@ref(tibble)","\\@ref(list)")
d <- data.frame(Type, Section)
knitr::kable(d)
```

We will focus on atomic vectors in Chapters \@ref(basic-vectors) and \@ref(advanced-vectors) and explore the remaining object types in Chapter \@ref(object-other-type).
