...
::: {.infobox .caution data-latex="{caution}"}
SAS variable names must be at most 32 characters. If any column name in your data frame exceeds this limit, `write_sas()` will throw an error (not silently truncate). Rename long columns with `names()` or `dplyr::rename()` before exporting.
:::
