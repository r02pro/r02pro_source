...
Here, `y1` is a length-5 vector (`c(1, 3, 5, 2, 4)`) and `x1` is a length-1 vector (`6`). R internally recycles `x1` into `c(6, 6, 6, 6, 6)` and then performs element-wise addition:
