...
Because `sample()` draws random values, you will get different results every time you call `roll_dice(10)`. To make the output **reproducible**, call `set.seed()` with any integer right before the function call — every reader who runs the same seed will obtain the same rolls.
