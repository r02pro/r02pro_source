...
The 25-th percentile (0.25 quantile), also called the **first quartile**, is the value such that at least 25 percent (or a quarter) of all data points are less than or equal to it. For vector `h`, the value is 2 since there are 2 numbers (out of 5) that are less than or equal to 2, and $2/5 \ge 0.25$.

Similarly, the 75-th percentile, also called the **third quartile**, is the value such that at least 75 percent of all data points are less than or equal to it. For vector `h`, the value is 75 since there are 4 numbers (out of 5) that are less than or equal to 75, and $4/5 \ge 0.75$.
...
As before, this asks R to compute the 95th percentile, meaning at least 95 percent of all data points are less than or equal to this value. Because you only have 5 values in this vector, it may not be very intuitive. However, if you have more elements in a vector, say 1000, about 950 of them (95 percent of 1000) will be less than or equal to this value.
