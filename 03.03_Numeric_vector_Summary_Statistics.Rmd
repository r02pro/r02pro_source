...
The 25-th percentile (0.25 quantile), also called the **first quartile**, is the value such that at least 25 percent (or a quarter) of all data points are less than or equal to it. For vector `h`, the value is 2 since there is 1 number (out of 5) that is less than or equal to 2, and $1/5 \ge 0.25$.
