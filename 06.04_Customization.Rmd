...
Although the two figures look visually identical, the log-scale plot is often easier to interpret because the axis tick labels stay on the **original scale** of the variable (e.g., $1{,}000$, $10{,}000$, $100{,}000$) rather than showing transformed values ($3$, $4$, $5$). Readers can therefore map tick marks back to the real-world quantity without mentally undoing the logarithm.
